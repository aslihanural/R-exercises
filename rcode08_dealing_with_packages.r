...
# only show where installed, version, and 'priority'
...
axis(side=2, at=seq(0,15000,1000), las=2)
...
if (!require(packagefinder)) install.packages("packagefinder")
...
if (!require(CRANsearcher)) install.packages("CRANsearcher")
...
# also (potentially?) useful: https://rdrr.io/
